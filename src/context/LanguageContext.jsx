...
const translations = {
  en: {
    ...
    im: "I'm",
    name: "Atef Elhamsa",
    typewriterFullStack: "Full Stack Developer",
    typewriterFlutterNode: "Flutter & Node.js Developer",
    typewriterInstructor: "Tech Instructor",
    typewriterUIUX: "Flutter Specialist",
    typewriterMobileSpec: "UI/UX Designer",
    founderTitle: "Founder & CEO @ C&C Academy",
    heroDesc: "Crafting high-performance, beautiful cross-platform mobile experiences and robust backends with Flutter, Node.js, and state-of-the-art architectures.",
    ...
    // Aboutme
    aboutTitle: "About Me",
    aboutRole: "Full Stack Developer | Flutter & Node.js Developer | Founder of C&C Academy",
    aboutDesc: "Passionate Full Stack Developer skilled in Flutter, Node.js, and cross-platform mobile development. As the Founder & CEO of C&C Academy, I lead initiatives in tech education. I specialize in building responsive, user-friendly mobile applications and robust backends with clean, efficient code and modern UI designs. With experience in state management solutions like Provider, Riverpod, and Bloc, as well as Firebase, Node.js, and RESTful APIs, I focus on delivering seamless performance and engaging user experiences.",
    ...
    lvlSolidFoundation: "Solid Foundation",
    lvlPixelPerfect: "Pixel Perfect",
    lvlCoreLogic: "Core Logic",
    lvlDeepExpertise: "Deep Expertise",
    lvlProductionReady: "Production Ready",
    lvlComplexStates: "Complex States",
    lvlCiCdFlow: "CI/CD & Flow",
    lvlAppArchitecture: "App Architecture",
    ...
    // Timeline
    timelineCcDate: "August 2026 – Present",
    ccAcad: "C&C Academy",
    roleFounder: "Founder & CEO",
    teachingAndManaging: "Leading tech education and managing the academy's vision.",
  ...
  ar: {
    ...
    im: "أنا",
    name: "عاطف الهمسة",
    typewriterFullStack: "مطور شامل (Full Stack)",
    typewriterFlutterNode: "مطور Flutter و Node.js",
    typewriterInstructor: "محاضر تقني",
    typewriterUIUX: "أخصائي فلاتر (Flutter)",
    typewriterMobileSpec: "مصمم واجهات UI/UX",
    founderTitle: "مؤسس ومدير تنفيذي @ أكاديمية C&C",
    heroDesc: "ابتكار تطبيقات هاتف مميزة وواجهات خلفية قوية، عالية الأداء وجميلة عبر الأنظمة باستخدام Flutter و Node.js وبنيات واجهة مستخدم حديثة.",
    techStack: "التقنيات:",
    ...
    // Aboutme
    aboutTitle: "من أنا",
    aboutRole: "مطور شامل (Full Stack) | مطور Flutter و Node.js | مؤسس أكاديمية C&C",
    aboutDesc: "مطور شامل شغوف ومتميز في تطوير تطبيقات الهاتف والواجهات الخلفية باستخدام Flutter و Node.js. بصفتي مؤسس ومدير تنفيذي لأكاديمية C&C، أقود مبادرات في التعليم التقني. أتميز ببناء تطبيقات متجاوبة وسهلة الاستخدام مع كود نظيف وفعال. مع خبرة في حلول إدارة الحالة مثل Provider و Riverpod و Bloc، بالإضافة إلى Firebase و Node.js و RESTful APIs، أركز على تقديم أداء سلس وتجارب مستخدم جذابة.",
    ...
    lvlSolidFoundation: "أساس قوي",
    lvlPixelPerfect: "دقة متناهية",
    lvlCoreLogic: "منطق أساسي",
    lvlDeepExpertise: "خبرة عميقة",
    lvlProductionReady: "جاهز للإنتاج",
    lvlComplexStates: "إدارة الحالات المعقدة",
    lvlCiCdFlow: "تكامل وتسليم مستمر",
    lvlAppArchitecture: "هيكلة التطبيقات",
    ...
    // Timeline
    timelineCcDate: "أغسطس 2026 – الحاضر",
    ccAcad: "أكاديمية C&C",
    roleFounder: "مؤسس ومدير تنفيذي",
    teachingAndManaging: "قيادة التعليم التقني وإدارة رؤية الأكاديمية.",
